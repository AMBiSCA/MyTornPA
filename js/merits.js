...
const allHonors = [
    ...
    // Casino
    { id: 276, name: "Lucky Break", requirement: "Win the daily, weekly or monthly Lottery jackpot", statKey: "personalstats.lottery_jackpot_wins", threshold: 1, category: "misc-awards-list", type: "count" },
    { id: 275, name: "Jackpot", requirement: "Win the Slot Machine jackpot", statKey: "personalstats.slot_jackpot_wins", threshold: 1, category: "misc-awards-list", type: "count" },
    { id: 237, name: "Poker King", requirement: "Reach a Poker score of 10 million", statKey: "personalstats.poker_score", threshold: 10000000, category: "misc-awards-list", type: "count" },
    ...
    { id: 513, name: "Daddy's New Shoes", requirement: "Win $100,000,000 in a single game of Russian Roulette", statKey: "personalstats.roulettefoot_max_win", threshold: 100000000, category: "misc-awards-list", type: "count" },
    { id: 519, name: "Foot Soldier", requirement: "Beat 10 unique opponents in Russian Roulette", statKey: "personalstats.roulettefoot_unique_opponents", threshold: 10, category: "misc-awards-list", type: "count" },
    { id: 338, name: "Twenty-One", requirement: "Win a Natural, Six Card Charlie, Double Down and Insurance on Blackjack", statKey: "personalstats.blackjack_wins", threshold: 4, category: "misc-awards-list", type: "count" },
    { id: 427, name: "Awesome", requirement: "Win while spinning the Wheel of Awesome", statKey: "personalstats.wheel_of_awesome_wins", threshold: 1, category: "misc-awards-list", type: "count" },
    { id: 437, name: "Mediocre", requirement: "Win while spinning the Wheel of Mediocrity", statKey: "personalstats.wheel_of_mediocrity_wins", threshold: 1, category: "misc-awards-list", type: "count" },
    { id: 431, name: "Lame", requirement: "Win while spinning the Wheel of Lame", statKey: "personalstats.wheel_of_lame_wins", threshold: 1, category: "misc-awards-list", type: "count" },

    // Dirty Bombs
    { id: 231, name: "Discovery", requirement: "Be in a faction which starts making a dirty bomb", statKey: "personalstats.dirtybomb_participated", threshold: 1, category: "misc-awards-list", type: "count" },
    ...
    { id: 55, name: "Combat Bachelor", requirement: "Complete all Combat Training courses", statKey: "personalstats.education_combat", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 56, name: "ICT Bachelor", requirement: "Complete all Computer Science courses", statKey: "personalstats.education_ict", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 58, name: "General Bachelor", requirement: "Complete all General Studies courses", statKey: "personalstats.education_general", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 59, name: "Fitness Bachelor", requirement: "Complete all Health & Fitness courses", statKey: "personalstats.education_fitness", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 60, name: "History Bachelor", requirement: "Complete all History courses", statKey: "personalstats.education_history", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 61, name: "Law Bachelor", requirement: "Complete all Law courses", statKey: "personalstats.education_law", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 62, name: "Mathematics Bachelor", requirement: "Complete all Maths courses", statKey: "personalstats.education_maths", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 63, name: "Psychology Bachelor", requirement: "Complete all Psychology courses", statKey: "personalstats.education_psychology", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 57, name: "Defense Bachelor", requirement: "Complete all Self Defence courses", statKey: "personalstats.education_defense", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 64, name: "Sports Bachelor", requirement: "Complete all Sports Science courses", statKey: "personalstats.education_sports", threshold: 1, category: "misc-awards-list", type: "boolean" },
    ...
    { id: 653, name: "Smart Alec", requirement: "Complete 10 Education courses", statKey: "personalstats.courses_completed", threshold: 10, category: "misc-awards-list", type: "count" },
    { id: 659, name: "Clever Dick", requirement: "Complete 25 Education courses", statKey: "personalstats.courses_completed", threshold: 25, category: "misc-awards-list", type: "count" },
    { id: 651, name: "Wise Guy", requirement: "Complete 50 Education courses", statKey: "personalstats.courses_completed", threshold: 50, category: "misc-awards-list", type: "count" },
    { id: 656, name: "Whiz Kid", requirement: "Complete 100 Education courses", statKey: "personalstats.courses_completed", threshold: 100, category: "misc-awards-list", type: "count" },
    { id: 844, name: "Worker Bee", requirement: "Achieve 10,000 in any working stat", statKey: "personalstats.totalworkingstats", threshold: 10000, category: "misc-awards-list", type: "count" },

    // Gyms & Stats (Gyms are complex, may need separate endpoint/logic)
    { id: 233, name: "Bronze Belt", requirement: "Own all lightweight gym memberships", statKey: "personalstats.gym_memberships.lightweight", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 234, name: "Silver Belt", requirement: "Own all middleweight gym memberships", statKey: "personalstats.gym_memberships.middleweight", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 235, name: "Gold Belt", requirement: "Own all heavyweight gym memberships", statKey: "personalstats.gym_memberships.heavyweight", threshold: 1, category: "misc-awards-list", type: "boolean" },
    ...
    { id: 12, name: "Pocket Money", requirement: "Make an investment in the city bank", statKey: "personalstats.bank_investments", threshold: 1, category: "misc-awards-list", type: "count" },
    { id: 10, name: "Green, Green Grass", requirement: "Make an investment in the city bank of over $1,000,000,000", statKey: "personalstats.bank_investments", threshold: 1000000000, category: "misc-awards-list", type: "count" },
    ...
    { id: 19, name: "Stock Analyst", requirement: "Achieve excellent success in the stock market", statKey: "personalstats.stocknetprofits", threshold: 1, category: "misc-awards-list", type: "count" },
    ...
    { id: 869, name: "Monopoly", requirement: "Own every stock benefit at the same time", statKey: "personalstats.stock_monopoly", threshold: 1, category: "misc-awards-list", type: "boolean" },
    ...
    { id: 1006, name: "Bearish", requirement: "Achieve $1,000,000,000 in total losses in the Stock Market", statKey: "personalstats.stocklosses", threshold: 1000000000, category: "misc-awards-list", type: "count" },
    ...
    { id: 8, name: "Loan Shark", requirement: "Achieve a high credit score with Duke the Loan Shark.", statKey: "personalstats.duke_credit_score", threshold: 1, category: "misc-awards-list", type: "count" },
    ...
    // Church
    { id: 520, name: "Pious", requirement: "Donate a total of $100,000 to the church", statKey: "personalstats.churchdonated", threshold: 100000, category: "misc-awards-list", type: "count" },
    { id: 521, name: "Saintly", requirement: "Donate a total of $1,000,000 to the church", statKey: "personalstats.churchdonated", threshold: 1000000, category: "misc-awards-list", type: "count" },
    { id: 316, name: "Forgiven", requirement: "Be truly forgiven for all of your sins", statKey: "personalstats.forgiven_sins", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 523, name: "Devout", requirement: "Donate a total of $100,000,000 to the church", statKey: "personalstats.churchdonated", threshold: 100000000, category: "misc-awards-list", type: "count" },
    { id: 522, name: "Sacrificial", requirement: "Donate $1,000,000,000 to the church", statKey: "personalstats.churchdonated", threshold: 1000000000, category: "misc-awards-list", type: "count" },
    ...
    { id: 252, name: "Freedom Isn't Free", requirement: "Bail 500 players out of jail", statKey: "personalstats.bails_given", threshold: 500, category: "misc-awards-list", type: "count" },
    ...
    { id: 406, name: "Vampire", requirement: "Random chance upon using a blood bag", statKey: "personalstats.vampire_blood_bags", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 367, name: "Clotted", requirement: "Hospitalize yourself by using the wrong blood bag or drinking some Ipecac Syrup.", statKey: "personalstats.self_hospitalized_wrong_blood_bag", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 418, name: "Transfusion", requirement: "Fill 250 blood bags", statKey: "personalstats.blood_bags_filled", threshold: 250, category: "misc-awards-list", type: "count" },
    { id: 398, name: "Anaemic", requirement: "Fill 1,000 blood bags", statKey: "personalstats.blood_bags_filled", threshold: 1000, category: "misc-awards-list", type: "count" },
    { id: 322, name: "Miracle Worker", requirement: "Revive 10 people in 10 minutes", statKey: "personalstats.miracle_worker_revives", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 870, name: "Resurrection", requirement: "Revive someone you've just defeated", statKey: "personalstats.resurrection_revives", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 863, name: "Crucifixion", requirement: "Defeat someone you've just revived", statKey: "personalstats.crucifixion_defeats", threshold: 1, category: "misc-awards-list", type: "boolean" },

    // Commitment (Leveling and Age are better as Medals; Forgiven is Church-related)
    { id: 873, name: "Welcome", requirement: "Be online everyday for 100 days", statKey: "personalstats.activestreak", threshold: 100, category: "misc-awards-list", type: "count" },
    { id: 245, name: "Couch Potato", requirement: "Reach 1,000 hours of Time Played on Torn", statKey: "personalstats.useractivity", threshold: 3600000, category: "misc-awards-list", type: "count" }, // Convert hours to seconds
    ...
    { id: 743, name: "Lavish", requirement: "Dump an item with a current market value of at least $1,000,000", statKey: "personalstats.items_dumped_value", threshold: 1000000, category: "misc-awards-list", type: "count" },
    ...
    { id: 678, name: "Stinker", requirement: "Successfully prank someone with Stink Bombs", statKey: "personalstats.pranks_stink_bomb", threshold: 1, category: "misc-awards-list", type: "count" },
    { id: 716, name: "Wipeout", requirement: "Successfully prank someone with Toilet Paper", statKey: "personalstats.pranks_toilet_paper", threshold: 1, category: "misc-awards-list", type: "count" },
    ...
    { id: 717, name: "Foul Play", requirement: "Successfully prank someone with Dog Poop", statKey: "personalstats.pranks_dog_poop", threshold: 1, category: "misc-awards-list", type: "count" },
    ...
    { id: 699, name: "Collector", requirement: "Maintain an impressive display case of collectible items", statKey: "personalstats.display_case_value", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 882, name: "Radaway", requirement: "Use a Neumune Tablet to reduce radiation poisoning", statKey: "personalstats.neumune_used", threshold: 1, category: "misc-awards-list", type: "count" },

    // Miscellaneous (Honors)
    { id: 266, name: "Energize", requirement: "Use 250 Energy Refills", statKey: "personalstats.nerverefills", threshold: 250, category: "misc-awards-list", type: "count" },
    ...
    { id: 220, name: "The Affronted", requirement: "Irritate all job interviewers", statKey: "personalstats.job_interviewers_irritated", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 395, name: "Energetic", requirement: "Achieve the maximum of 1,000 energy", statKey: "personalstats.energy_maxed", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 380, name: "Ecstatic", requirement: "Achieve the maximum of 99,999 happiness", statKey: "personalstats.happiness_maxed", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 309, name: "Christmas in Torn", requirement: "Login on Christmas Day", statKey: "personalstats.christmas_logins", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 443, name: "Trick or Treat", requirement: "Login on Halloween", statKey: "personalstats.halloween_logins", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 459, name: "Torniversary", requirement: "Login on November 15th", statKey: "personalstats.torniversary_logins", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 607, name: "Buffed", requirement: "Achieve 50 personal perks", statKey: "personalstats.perks_obtained", threshold: 50, category: "misc-awards-list", type: "count" },
    { id: 244, name: "Web Of Perks", requirement: "Achieve 100 personal perks", statKey: "personalstats.perks_obtained", threshold: 100, category: "misc-awards-list", type: "count" },
    { id: 620, name: "OP", requirement: "Achieve 150 personal perks", statKey: "personalstats.perks_obtained", threshold: 150, category: "misc-awards-list", type: "count" },
    { id: 617, name: "10-Stack", requirement: "Increase a merit upgrade to its maximum", statKey: "personalstats.merit_upgrades_maxed", threshold: 1, category: "misc-awards-list", type: "boolean" },
    ...
    { id: 312, name: "Time Traveller", requirement: "Survive a Torn City rollback", statKey: "personalstats.rollbacks_survived", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 288, name: "Fresh Start", requirement: "Reset your merits", statKey: "personalstats.merits_reset", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 731, name: "Tornication", requirement: "Login on Valentine's Day", statKey: "personalstats.valentines_logins", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 114077, name: "Resolution", requirement: "Login on New Year's Day", statKey: "personalstats.new_years_logins", threshold: 1, category: "misc-awards-list", type: "boolean" }, // Note: This ID needs verification as 114077 isn't in original maps
    { id: 700, name: "Leaderboard", requirement: "Achieve top 250 in one of the personal Hall of Fame leaderboards", statKey: "personalstats.hof_rankings_achieved", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 839, name: "RNG", requirement: "Who knows?", statKey: "personalstats.rng_award", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 845, name: "Historian", requirement: "Read a chronicle", statKey: "personalstats.chronicles_read", threshold: 1, category: "misc-awards-list", type: "count" },
    { id: 888, name: "Nice", requirement: "100 job points used", statKey: "personalstats.jobpointsused", threshold: 100, category: "misc-awards-list", type: "count" }, // This might be a mistake, "Nice" is Honor 888, not job points related.
    ...
    // Newspaper
    { id: 5, name: "Journalist", requirement: "Have an article published", statKey: "personalstats.articles_published", threshold: 1, category: "misc-awards-list", type: "count" },
    { id: 167, name: "Velutinous", requirement: "Have a comic published", statKey: "personalstats.comics_published", threshold: 1, category: "misc-awards-list", type: "count" },

    // Properties
    { id: 9, name: "Luxury Real Estate", requirement: "Own a Private Island with a Airstrip", statKey: "personalstats.property_id", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 258, name: "High Life", requirement: "Own a Private Island with a Yacht", statKey: "personalstats.property_id", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 860, name: "Landlord", requirement: "Lease one of your properties to someone.", statKey: "personalstats.properties_leased", threshold: 1, category: "misc-awards-list", type: "count" },
    ...
    { id: 21, name: "Driving Elite", requirement: "Reach Class A", statKey: "personalstats.racing_class", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 274, name: "Redline", requirement: "250 wins in the same car", statKey: "personalstats.racing_car_wins", threshold: 250, category: "misc-awards-list", type: "count" },
    ...
    { id: 734, name: "Wrecked", requirement: "Crash during a race", statKey: "personalstats.races_crashed", threshold: 1, category: "misc-awards-list", type: "count" },
    ...
    // Recruit Citizens
    { id: 217, name: "Two's Company", requirement: "Refer 1 player who reaches level 10", statKey: "personalstats.referrals_lvl10", threshold: 1, category: "misc-awards-list", type: "count" },
    { id: 218, name: "Three's A Crowd", requirement: "Refer 2 players who reach level 10", statKey: "personalstats.referrals_lvl10", threshold: 2, category: "misc-awards-list", type: "count" },
    { id: 219, name: "Social Butterfly", requirement: "Refer 3 players who reach level 10", statKey: "personalstats.referrals_lvl10", threshold: 3, category: "misc-awards-list", type: "count" },
    { id: 246, name: "Pyramid Scheme", requirement: "Have one of your referrals refer another player who goes on to reach level 10", statKey: "personalstats.referral_pyramid", threshold: 1, category: "misc-awards-list", type: "boolean" },

    // Competitions, Token Shop & Points Building
    { id: 213, name: "Allure", requirement: "Make an entry for Mr/Miss Torn", statKey: "personalstats.mrmiss_torn_entries", threshold: 1, category: "misc-awards-list", type: "count" },
    { id: 222, name: "Good Friday", requirement: "Exchange all eggs for a gold one in the Easter Egg hunt competition", statKey: "personalstats.easter_gold_egg_exchanged", threshold: 1, category: "misc-awards-list", type: "boolean" },
    { id: 221, name: "KIA", requirement: "Collect 50 dog tags in the Dog Tags competition (must be holding 50 tags at once)", statKey: "personalstats.dog_tags_collected", threshold: 50, category: "misc-awards-list", type: "count" },
    { id: 277, name: "Departure", requirement: "Collect 250 dog tags in the Dog Tags competition (must be holding 250 tags at once)", statKey: "personalstats.dog_tags_collected", threshold: 250, category: "misc-awards-list", type: "count" },
    { id: 212, name: "Mission Accomplished", requirement: "Finish the Elimination competition with your team 1st, 2nd or 3rd.", statKey: "personalstats.elimination_team_rank", threshold: 3, category: "misc-awards-list", type: "count_less_equal" },
    { id: 226, name: "Purple Heart", requirement: "Make 50 attacks against enemy team members in the Elimination competition.", statKey: "personalstats.elimination_attacks", threshold: 50, category: "misc-awards-list", type: "count" },
    { id: 5999, name: "Supremacy", requirement: "Finish the Elimination competition within the top 5% of attacking players in your team.", statKey: "personalstats.elimination_rank_percentile", threshold: 5, category: "misc-awards-list", type: "count_less_equal" }, // Note: This ID needs verification, 5999 not in map
    { id: 279, name: "Domination", requirement: "Finish the Elimination competition with your team in 1st place.", statKey: "personalstats.elimination_team_rank", threshold: 1, category: "misc-awards-list", type: "count" },
    { id: 330, name: "Champion", requirement: "Win a community event", statKey: "personalstats.community_event_wins", threshold: 1, category: "misc-awards-list", type: "count" },
    { id: 969, name: "Phantastic", requirement: "Upgrade your Halloween Basket to Frightful Trick or Treat", statKey: "personalstats.halloween_basket_upgrades", threshold: 1, category: "misc-awards-list", type: "count" },
    { id: 964, name: "Something Humerus", requirement: "Upgrade your Halloween Basket to Terrifying Trick or Treat", statKey: "personalstats.halloween_basket_upgrades", threshold: 2, category: "misc-awards-list", type: "count" },
    { id: 966, name: "Oh My Gourd!", requirement: "Upgrade your Halloween Basket to Nightmarish Trick or Treat", statKey: "personalstats.halloween_basket_upgrades", threshold: 3, category: "misc-awards-list", type: "count" },

    // Token Shop (These are purchases, not directly tied to stats usually)
    { id: 283, name: "Globule", requirement: "Purchased for 3 tokens from the Token Shop or for 500 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 3, category: "misc-awards-list", type: "count" },
    { id: 308, name: "Retro", requirement: "Purchased for 4 tokens from the Token Shop or for 500 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 4, category: "misc-awards-list", type: "count" },
    { id: 298, name: "Acute", requirement: "Purchased for 4 tokens from the Token Shop or for 500 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 4, category: "misc-awards-list", type: "count" },
    { id: 313, name: "Serenity", requirement: "Purchased for 5 tokens from the Token Shop or for 600 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 5, category: "misc-awards-list", type: "count" },
    { id: 223, name: "The Socialist", requirement: "Purchased for 5 tokens from the Token Shop or for 600 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 5, category: "misc-awards-list", type: "count" },
    { id: 214, name: "Jack Of All Trades", requirement: "Purchased for 5 tokens from the Token Shop or for 600 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 5, category: "misc-awards-list", type: "count" },
    { id: 318, name: "Futurity", requirement: "Purchased for 6 tokens from the Token Shop or for 700 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 6, category: "misc-awards-list", type: "count" },
    { id: 297, name: "Constellations", requirement: "Purchased for 7 tokens from the Token Shop or for 700 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 7, category: "misc-awards-list", type: "count" },
    { id: 281, name: "Parallel", requirement: "Purchased for 8 tokens from the Token Shop or for 700 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 8, category: "misc-awards-list", type: "count" },
    { id: 215, name: "Labyrinth", requirement: "Purchased for 9 tokens from the Token Shop or for 700 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 9, category: "misc-awards-list", type: "count" },
    { id: 315, name: "Glimmer", requirement: "Purchased for 10 tokens from the Token Shop or for 800 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 10, category: "misc-awards-list", type: "count" },
    { id: 224, name: "Proven Capacity", requirement: "Purchased for 10 tokens from the Token Shop or for 800 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 10, category: "misc-awards-list", type: "count" },
    { id: 225, name: "Master Of One", requirement: "Purchased for 10 tokens from the Token Shop or for 800 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 10, category: "misc-awards-list", type: "count" },
    { id: 278, name: "Globally Effective", requirement: "Purchased for 10 tokens from the Token Shop or for 800 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 10, category: "misc-awards-list", type: "count" },
    { id: 321, name: "Supernova", requirement: "Purchased for 12 tokens from the Token Shop or for 900 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 12, category: "misc-awards-list", type: "count" },
    { id: 294, name: "Pepperoni", requirement: "Purchased for 13 tokens from the Token Shop or for 900 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 13, category: "misc-awards-list", type: "count" },
    { id: 284, name: "Electric Dream", requirement: "Purchased for 15 tokens from the Token Shop or for 1000 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 15, category: "misc-awards-list", type: "count" },
    { id: 306, name: "Resistance", requirement: "Purchased for 15 tokens from the Token Shop or for 1000 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 15, category: "misc-awards-list", type: "count" },
    { id: 311, name: "Brainz", requirement: "Purchased for 20 tokens from the Token Shop or for 1300 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 20, category: "misc-awards-list", type: "count" },
    { id: 263, name: "Survivor", requirement: "Purchased for 25 tokens from the Token Shop or for 1500 points from the Points Building", statKey: "personalstats.tokens_spent", threshold: 25, category: "misc-awards-list", type: "count" },
    { id: 730, name: "Backdrop", requirement: "Unlock a backdrop from the Token Shop", statKey: "personalstats.backdrops_unlocked", threshold: 1, category: "misc-awards-list", type: "count" },
    { id: 729, name: "Hairy", requirement: "Unlock a hairstyle from the Token Shop", statKey: "personalstats.hairstyles_unlocked", threshold: 1, category: "misc-awards-list", type: "count" },

    // Travel (Some covered, many more country-specific)
    { id: 11, name: "Mile High Club", requirement: "Travel 100 times", statKey: "personalstats.traveltimes", threshold: 100, category: "misc-awards-list", type: "count" },
    { id: 165, name: "There And Back Again", requirement: "Travel 1,000 times", statKey: "personalstats.traveltimes", threshold: 1000, category: "misc-awards-list", type: "count" },
    { id: 131, name: "Cascado", requirement: "Travel to Mexico 50 times", statKey: "personalstats.mextravel", threshold: 50, category: "misc-awards-list", type: "count" },
    { id: 139, name: "Toronto", requirement: "Travel to Canada 50 times", statKey: "personalstats.cantravel", threshold: 50, category: "misc-awards-list", type: "count" },
    { id: 272, name: "Shark Bait", requirement: "Travel to Cayman Islands 50 times", statKey: "personalstats.caytravel", threshold: 50, category: "misc-awards-list", type: "count" },
    { id: 133, name: "Hula", requirement: "Travel to Hawaii 50 times", statKey: "personalstats.hawtravel", threshold: 50, category: "misc-awards-list", type: "count" },
    { id: 135, name: "British Pride", requirement: "Travel to England 50 times", statKey: "personalstats.lontravel", threshold: 50, category: "misc-awards-list", type: "count" },
    { id: 137, name: "Like The Celebs", requirement: "Travel to Switzerland 50 times", statKey: "personalstats.switravel", threshold: 50, category: "misc-awards-list", type: "count" },
    { id: 130, name: "Maradona", requirement: "Travel to Argentina 50 times", statKey: "personalstats.argtravel", threshold: 50, category: "misc-awards-list", type: "count" },
    { id: 134, name: "The Rising Sun", requirement: "Travel to Japan 50 times", statKey: "personalstats.japtravel", threshold: 50, category: "misc-awards-list", type: "count" },
    { id: 138, name: "Year Of The Dragon", requirement: "Travel to China 50 times", statKey: "personalstats.chitravel", threshold: 50, category: "misc-awards-list", type: "count" },
    { id: 132, name: "Land Of Promise", requirement: "Travel to Dubai 50 times", statKey: "personalstats.dubtravel", threshold: 50, category: "misc-awards-list", type: "count" },
    { id: 136, name: "Cape Town", requirement: "Travel to South Africa 50 times", statKey: "personalstats.soutravel", threshold: 50, category: "misc-awards-list", type: "count" },
    { id: 549, name: "Tourist", requirement: "Spend 7 days in the air", statKey: "personalstats.traveltime", threshold: 604800, category: "misc-awards-list", type: "count" }, // 7 days in seconds
    { id: 567, name: "Frequent Flyer", requirement: "Spend 31 days in the air", statKey: "personalstats.traveltime", threshold: 2678400, category: "misc-awards-list", type: "count" }, // 31 days in seconds
    { id: 557, name: "Globetrotter", requirement: "Spend 365 days in the air", statKey: "personalstats.traveltime", threshold: 31536000, category: "misc-awards-list", type: "count" }, // 365 days in seconds
    ...
    { id: 853, name: "Souvenir", requirement: "Purchase the perfect souvenir abroad", statKey: "personalstats.souvenirs_bought", threshold: 1, category: "misc-awards-list", type: "count" },
...
function applyAwardedTicks(playerData) {
    ...
    document.querySelectorAll('li.achievement-item').forEach(listItem => {
        ...
        if (isAwarded) {
            listItem.classList.add('awarded-by-api'); // Add class for CSS styling (the green box)
            ...
            if (!existingTick) {
                ...
                tickSpan.textContent = ' ✔'; // DIRECTLY INSERT UNICODE CHECKMARK EMOJI (or '✔' if you prefer solid)
                
                // Append the tick inside the merit-details span
