...
const allHonors = [
    // --- Chaining Honors ---
    { name: "Chainer 1", requirement: "Participate in a 10 length chain", statKey: "chain.max", threshold: 10, category: "honors-chaining-list", type: "count" },
...
async function fetchTornDataDirectly(apiKey) {
    ...
    const selections = "basic,personalstats,chaingains";
