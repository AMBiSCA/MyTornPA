...
// REMOVED: const playerRankSpan = document.getElementById('player-rank'); // This line is removed
const playerNetworthSpan = document.getElementById('player-networth');
// REMOVED: const playerLifeSpan = document.getElementById('player-life'); // This line is removed
...
const awardsProgressList = document.getElementById('awards-progress-list'); // For Awards Progress tab
...
const allHonors = [
    ...
    { name: "Leonidas", requirement: "Achieve a finishing hit with Kick", statKey: "personalstats.kickhits", threshold: 1, category: "honors-weapons-list", type: "count" },
    { name: "Lend A Hand", requirement: "Achieve 100 finishing hits with machine guns", statKey: "personalstats.machits", threshold: 100, category: "honors-weapons-list", type: "count" },
    { name: "Pin Puller", requirement: "Achieve 100 finishing hits with temporary weapons", statKey: "personalstats.temphits", threshold: 100, category: "honors-weapons-list", type: "count" },
    { name: "Machinist", requirement: "Achieve 100 finishing hits with mechanical weapons", statKey: "personalstats.mechits", threshold: 100, category: "honors-weapons-list", type: "count" },
    ...
    { name: "Stumped", requirement: "Achieve 100 finishing hits with heavy artillery", statKey: "personalstats.artihits", threshold: 100, category: "honors-weapons-list", type: "count" },
    ...
    { name: "Modded", requirement: "Equip two high-tier mods to a weapon", statKey: "personalstats.modded_weapons", threshold: 1, category: "honors-weapons-list", type: "count" },
    { name: "Specialist", requirement: "Achieve 100% EXP on 25 different weapons", statKey: "personalstats.weapons_mastered", threshold: 25, category: "honors-weapons-list", type: "count" },
...
function displayPlayerSummary(playerData) {
    ...
    if (playerData) {
        ...
        // REMOVED: Rank and Life from summary display
        // const playerRank = 'N/A'; // No longer needed
        // playerRankSpan.textContent = playerRank; // No longer needed
        // const life = playerData.personalstats ? playerData.personalstats.life : undefined; // No longer needed
        // if (playerLifeSpan) { playerLifeSpan.textContent = life !== undefined ? formatNumber(life) : 'N/A'; } // No longer needed
        ...
        // console.log(`  Rank (after checks): ${playerRankSpan.textContent}`); // Removed from logs
        console.log(`  Networth: ${playerNetworthSpan.textContent}`);
        // console.log(`  Life: ${playerLifeSpan ? playerLifeSpan.textContent : 'N/A (span not found)'}`); // Removed from logs
        ...
        // Fallbacks for removed spans
        // playerRankSpan.textContent = 'N/A'; // Removed
        // if (playerLifeSpan) { playerLifeSpan.textContent = 'N/A'; } // Removed
    }
}
            ...
            try {
                ...
                if (doc.exists && doc.data() && doc.data().tornApiKey) {
                    ...
                    if (playerData) {
                        ...
                        updateAchievementsDisplay(player