document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof auth !== 'undefined' && auth) { 
        auth.onAuthStateChanged(function(user) {
            ...
            if (user) { // User is signed in
                ...
                const allowedNonAuthPagesIncludingThis = [...nonAuthEntryPages, 'travel.html', 'terms.html', 'faq.html', 'about.html', 'report.html', 'merits.html', 'item_watcher.html']; 
    ...
    // Any item_watcher.html specific JavaScript actions for the tracker would go below this line.
