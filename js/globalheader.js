...
    function initializeHeaderLogicAfterLoad() {
    ...
    // --- Collapsible Header Toggle Logic ---
    const headerForToggle = document.querySelector('header');
    const toggleButton = document.getElementById('headerToggleButton');

    if (headerForToggle && toggleButton) {
        toggleButton.addEventListener('click', () => {
            headerForToggle.classList.toggle('header-collapsed');
        });
        console.log("globalheader.js: Collapsible header toggle attached.");
    }
    // --- End Collapsible Header Toggle ---
