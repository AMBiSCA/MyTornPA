...
    // First, save the original, native browser alert function BEFORE we override it.
...
        // This is the main fix: Find the elements every time the function is called.
        const customAlertEl = document.getElementById('customAlert');
...
            // This uses the original browser alert we saved earlier, preventing an infinite loop.
            nativeAlert(message);
        }
    };
    
