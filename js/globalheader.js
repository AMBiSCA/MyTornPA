...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // REMOVED: profileSetupTornStatsApiKeyInput as it's no longer in HTML
   ...
   closePersonalStatsModalBtn.addEventListener('click', function() {
        ...
        headerEditProfileBtn.addEventListener('click', async function(event) {
            ...
            try {
                ...
                if (doc.exists) {
                    ...
                    // REMOVED: if(profileSetupTornStatsApiKeyInput) profileSetupTornStatsApiKeyInput.value = data.tornStatsApiKey || '';
    ...
    if (saveProfileBtn && auth && db) {
        saveProfileBtn.addEventListener('click', async () => {
            // Updated check: profileSetupTornStatsApiKeyInput is now explicitly null (or not declared)
            ...
            const profileDataToSave = {
                ...
                // REMOVED: tornStatsApiKey: profileSetupTornStatsApiKeyInput.value.trim() || null,
