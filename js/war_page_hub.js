...
const saveWarStatusBtn = document.getElementById('saveWarStatusControlsBtn'); // Corrected ID from HTML
...
        if (message.trim() !== '') {
            try {
                // CORRECTED: Used .set({ merge: true }) to prevent error if document doesn't exist
...
            // Set text input values
			// This was a checkbox in the HTML, corrected to use .checked
...
            toggleTermedWinLoss: toggleTermedWinLoss.checked, // Corrected to use .checked for the checkbox
...
                        // NOTE: This function now calls the other load functions upon success.
