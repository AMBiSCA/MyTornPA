    ...
    try {
        ...
        allMembers.forEach(member => {
            ...
            if (memberAvailability) {
                ...
                // If no record exists for the member, they haven't responded
        ...
        // 6. Send the report to your backend
        const backendWebhookEndpoint = '/.netlify/functions/send-availability-webhook';
        const response = await fetch(backendWebhookEndpoint, {
            method: 'POST',
        ...
        // We throw the error so the calling function can handle UI updates
        throw error;
    }
}
