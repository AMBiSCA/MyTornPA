...
async function displayQuickFFTargets(userApiKey, playerId) {
    ...
    function toggleMobileView() {
        ...
        if (window.innerWidth <= mobileMaxWidth) {
            if (warInfoTab) {
                warInfoTab.style.setProperty('display', 'none', 'important');
            }
            if (liveActivityTab) {
                liveActivityTab.style.setProperty('display', 'none', 'important');
            }
            if (announcementScoreboard) {
                announcementScoreboard.style.setProperty('display', 'none', 'important');
            }
        } else {
