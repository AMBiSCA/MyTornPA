...
    if (homeButtonHeaderEl) homeButtonHeaderEl.style.display = 'none';
  }
...
  // --- Dropdown Logic (Useful Links & Contact Us) ---
  function closeAllDropdowns() {
    if (usefulLinksDropdown && usefulLinksDropdown.classList.contains('show')) {
        usefulLinksDropdown.classList.remove('show');
        if (usefulLinksBtn) usefulLinksBtn.classList.remove('active');
    }
    if (headerContactUsDropdown && headerContactUsDropdown.classList.contains('show')) {
        headerContactUsDropdown.classList.remove('show');
        if (headerContactUsBtn) headerContactUsBtn.classList.remove('active');
    }
  }
...
  if (headerContactUsBtn && headerContactUsDropdown) {
    headerContactUsBtn.addEventListener('click', function(event) {
      event.stopPropagation();
      const currentlyOpen = headerContactUsDropdown.classList.contains('show');
      closeAllDropdowns();
      if (!currentlyOpen) {
        headerContactUsDropdown.classList.add('show');
        headerContactUsBtn.classList.add('active');
      }
    });
  }

  window.addEventListener('click', function(event) {
    let clickedInsideUseful = false;
    if (usefulLinksBtn && usefulLinksDropdown) {
        clickedInsideUseful = usefulLinksBtn.contains(event.target) || usefulLinksDropdown.contains(event.target);
    }
    let clickedInsideContact = false;
    if (headerContactUsBtn && headerContactUsDropdown) {
        clickedInsideContact = headerContactUsBtn.contains(event.target) || headerContactUsDropdown.contains(event.target);
    }
    if (!clickedInsideUseful && usefulLinksDropdown && usefulLinksDropdown.classList.contains('show')) {
        usefulLinksDropdown.classList.remove('show');
        if (usefulLinksBtn) usefulLinksBtn.classList.remove('active');
    }
    if (!clickedInsideContact && headerContactUsDropdown && headerContactUsDropdown.classList.contains('show')) {
        headerContactUsDropdown.classList.remove('show');
        if (headerContactUsBtn) headerContactUsBtn.classList.remove('active');
    }
  });
