...
                } catch (error) { console.error('Faction & Profile data update via Netlify function failed:', error.message); }
            } else { console.warn("No faction data found in API response to send to Netlify function."); }
        } catch (error) {
