...
// Corrected: Merging the new function into the main DOMContentLoaded listener
document.addEventListener('DOMContentLoaded', () => {
...
    const gymError = document.getElementById('gymError');
    
    // ... (The rest of your existing variable declarations) ...
...
    // Run the new mobile hiding function when the page loads
    hideMobileStats();

    // ... (The rest of your existing DOMContentLoaded code, including event listeners, etc.) ...
});