...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // REMOVED ALL HEADER-RELATED LOGIC FROM HERE
    // The whatsNewListElement logic has been moved here to keep it in index.js
            ...
            utilitiesToShow.forEach(utility => {
                ...
                linkItem.addEventListener('click', (e) => {
                    ...
                    if (window.showCustomAlert) {
                        window.showCustomAlert(linkItem.dataset.message || 'No details provided.', linkItem.dataset.title || 'Notification');
                    } else {
                        alert(linkItem.dataset.message || 'No details provided.');
                    }
                });
    ...
    // All header dropdown and alert logic is now in globalheader.js
    // and is no longer needed here.


    // All header button event listeners and auth state logic is now in globalheader.js
    // and is no longer needed here.
